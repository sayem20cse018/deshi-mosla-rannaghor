...
const T = {
  ...
  // Announcement bar
  ann1:         { bn: '৳১০০০+ অর্ডারে সারাদেশে ফ্রি ডেলিভারি', en: 'Free delivery on orders over ৳1000 nationwide' },
  ann2:         { bn: 'কোড WELCOME10 — নতুন গ্রাহকদের ১০% ছাড়', en: 'Code WELCOME10 — 10% off for new customers'      },
  ann3:         { bn: 'ক্যাশ অন ডেলিভারি সুবিধা উপলব্ধ',        en: 'Cash on Delivery available'                      },
  ann4:         { bn: 'ঢাকায় একইদিন ডেলিভারি — সকাল ১১টার আগে', en: 'Same-day delivery in Dhaka — order before 11 AM'  },
