...
export default function ProfilePage() {
  ...
  async function handleProfileSave(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      await updateProfile({ name: form.name.trim(), gender: form.gender || undefined, dateOfBirth: form.dateOfBirth || undefined });
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="relative">
            ...
            <button className="absolute -bottom-1 -right-1 w-6 h-6 bg-brand-700 text-white rounded-full flex items-center justify-center hover:bg-brand-800 transition-colors" title="ছবি পরিবর্তন করুন">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
        ...
        {pwError && <div className="mb-4 bg-red-50 border border-red-200 text-red-700 text-sm px-4 py-3 rounded-xl">⚠️ {pwError}</div>}
          ...
          {[
            ...
            <div key={key}>
              ...
              <input
                ...
                placeholder={ph}
                className={cn('input-base', key === 'confirmPassword' && pwForm.confirmPassword && pwForm.newPassword !== pwForm.confirmPassword && 'border-red-400')}
