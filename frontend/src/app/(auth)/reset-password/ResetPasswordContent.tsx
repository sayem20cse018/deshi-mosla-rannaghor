...
export default function ResetPasswordContent() {
  ...
  if (!identifier || !otp) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-brand-50 via-white to-emerald-50">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-lg p-8 text-center max-w-sm w-full">
          <p className="text-gray-600 mb-4">অবৈধ অনুরোধ। আবার চেষ্টা করুন।</p>
          <Link href="/forgot-password" className="btn-primary px-6 py-2.5 inline-flex">
            পাসওয়ার্ড রিসেট শুরু করুন
          </Link>
        </div>
      </div>
    );
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={cn(
                      'input-base',
                      confirm && newPassword !== confirm && 'border-red-400',
                    )}
                    autoComplete="new-password"
                  />
                ...
                >
                  {loading ? (
                    <>
                      <Loader2 className="w-4 h-4 animate-spin" /> পরিবর্তন হচ্ছে...
                    </>
                  ) : (
