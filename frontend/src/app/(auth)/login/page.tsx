    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-50 via-white to-emerald-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mt-6 mb-1">আপনার অ্যাকাউন্টে লগইন করুন</h1>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/forgot-password" className="text-xs text-brand-600 hover:text-brand-800 font-medium">
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          নতুন গ্রাহক?{' '}
          <Link href="/register" className="text-brand-700 font-semibold hover:text-brand-800 underline underline-offset-2">
            নিবন্ধন করুন
          </Link>
        </p>
      </div>
