...
import {
  ...
  CreditCard, Star, Tag, Settings, LogOut, ChevronRight,
} from 'lucide-react';
      ...
      <div className="flex-1 space-y-0.5 overflow-y-auto">
        {NAV.map(({ href, icon: Icon, label }) => {
          ...
          return (
            ...
            >
              <Icon className={cn('w-4 h-4 flex-shrink-0', active ? 'text-brand-600' : 'text-gray-400 group-hover:text-brand-500')} />
