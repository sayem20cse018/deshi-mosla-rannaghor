...
const COLOR_MAP: Record<string, { color: string; border: string; text: string }> = {
  ...
  'tel':           { color: 'from-yellow-50 to-amber-50',  border: 'border-yellow-100', text: 'text-yellow-700' },
  ...
  'ata-maida':     { color: 'from-amber-50 to-yellow-50',  border: 'border-amber-100',  text: 'text-amber-700'  },
  'lobon':         { color: 'from-slate-50 to-gray-50',    border: 'border-slate-100',  text: 'text-slate-700'  },
  'chini-gur':     { color: 'from-orange-50 to-red-50',    border: 'border-orange-100', text: 'text-orange-700' },
  'cha-kofi':      { color: 'from-stone-50 to-amber-50',   border: 'border-stone-100',  text: 'text-stone-700'  },
  'snacks':        { color: 'from-pink-50 to-rose-50',     border: 'border-pink-100',   text: 'text-pink-700'   },
  'noodles':       { color: 'from-violet-50 to-purple-50', border: 'border-violet-100', text: 'text-violet-700' },
  'sauce-achar':   { color: 'from-lime-50 to-green-50',    border: 'border-lime-100',   text: 'text-lime-700'   },
  'modhu':         { color: 'from-yellow-50 to-orange-50', border: 'border-yellow-100', text: 'text-yellow-800' },
  'cooking-items': { color: 'from-teal-50 to-cyan-50',     border: 'border-teal-100',   text: 'text-teal-700'   },
};

const DEFAULT_STYLE = { color: 'from-brand-50 to-brand-100', border: 'border-brand-100', text: 'text-brand-700' };
