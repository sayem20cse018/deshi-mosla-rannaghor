    ...
    <section className="py-6">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 via-gray-800 to-orange-900 p-6 md:p-8 flex flex-col justify-between min-h-[160px]">
            <div className="absolute right-4 top-0 text-8xl opacity-15 select-none leading-none">
              🚚
            </div>
            <div>
              ...
              <h3 className="text-white text-2xl md:text-3xl font-bold leading-snug">
                ৳১০০০+ অর্ডারে
                <br />
                <span className="text-orange-300">ফ্রি ডেলিভারি!</span>
              </h3>
              <p className="text-white/80 text-sm mt-1">
            ...
            <Link
              href="/shop"
              className="mt-4 inline-flex items-center gap-2 bg-white text-orange-600 font-bold text-sm px-5 py-2.5 rounded-xl hover:bg-orange-50 transition-colors w-fit"
            >
