...
class UpdateProfileDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: false, type: () => String, maxLength: 100 }, avatar: { required: false, type: () => String }, gender: { required: false, type: () => String }, dateOfBirth: { required: false, type: () => String } };
    }
}
