...
class CreateVariantDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String, maxLength: 200 }, sku: { required: true, type: () => String, maxLength: 50 }, price: { required: true, type: () => Number, minimum: 0 }, salePrice: { required: false, type: () => Number, minimum: 0 }, stock: { required: false, type: () => Number, minimum: 0 }, weight: { required: false, type: () => String, maxLength: 50 }, image: { required: false, type: () => String, maxLength: 500 }, isActive: { required: false, type: () => Boolean }, sortOrder: { required: false, type: () => Number, minimum: 0 }, attributes: { required: false, type: () => Object } };
    }
}
...
class UpdateVariantDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: false, type: () => String, maxLength: 200 }, sku: { required: false, type: () => String, maxLength: 50 }, price: { required: false, type: () => Number, minimum: 0 }, salePrice: { required: false, type: () => Number, minimum: 0 }, stock: { required: false, type: () => Number, minimum: 0 }, weight: { required: false, type: () => String, maxLength: 50 }, image: { required: false, type: () => String, maxLength: 500 }, isActive: { required: false, type: () => Boolean }, sortOrder: { required: false, type: () => Number, minimum: 0 }, attributes: { required: false, type: () => Object } };
    }
}
...
__decorate([
    ...
    (0, class_validator_1.Min)(0),
    __metadata("design:type", Number)
], UpdateVariantDto.prototype, "salePrice", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Number),
