...
class UpdateReviewDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { rating: { required: false, type: () => Number, minimum: 1, maximum: 5 }, title: { required: false, type: () => String, maxLength: 200 }, comment: { required: false, type: () => String, maxLength: 2000 }, images: { required: false, type: () => [String] } };
    }
}
