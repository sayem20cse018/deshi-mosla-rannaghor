...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Submit a product review (must have purchased)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'sort', required: false, enum: ['latest', 'rating_high', 'rating_low'] }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)('access-token'),
    (0, swagger_1.ApiOperation)({ summary: 'Check if current user can review a product' }),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
